...
Kind of fun doing this exercises, specially the tic-tac-toe game. 

This is basically a fun challenge between what I previously learned about the `useState`, `useEffect` hook, and
practices such as *lift state* and *colocate state*

It was also great for don't forget about mutating state that is being managed, and how
this can lead pretty hard to track down bugs if update the state directly.

The extra credit exercise of add game history was pretty challenging, but I think it was a good exercise.
